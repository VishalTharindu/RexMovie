                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="mvid"  required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])){
                                            $invoid = mysqli_real_escape_string($conn, $_POST['mvid']);
                                            $sql = "SELECT * FROM userbooking WHERE invoId ='$invoid'  ORDER BY 1 DESC";
