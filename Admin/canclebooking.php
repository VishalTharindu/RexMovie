...
<head>
    ...
    <link href="assets/css/cancl.css" rel="stylesheet" type="text/css">
</head>
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li class="">
                            <form action="canclebookingShort.php" method="POST">
                                
                                    
                                        <input type="text" class="srh" name="invoid" placeholder="Enter Invoice No">
                                    
                                        <button type="submit" name="submit" class="bsty">Search</button>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li><a href="cshort.php">Short</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php 
                                        $sql = "SELECT * FROM cancledbookimg ORDER BY 1 DESC";
